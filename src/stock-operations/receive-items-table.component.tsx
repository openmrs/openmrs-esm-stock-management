...
const ReceiveItemsTable: React.FC<ReceiveItemTableProps> = ({
    ...
    const headers = [
        ...
        { key: 'quantityrequested', header: t('stockmanagement.stockoperation.items.quantityrequested'), styles: { width: "8%" } },
        { key: 'batch', header: t('stockmanagement.stockoperation.items.batch'), styles: { width: "15%" } },
        { key: 'expiry', header: t('stockmanagement.stockoperation.items.expiry'), styles: { width: "8%" } },
        { key: 'sentquantity', header: t('stockmanagement.stockoperation.items.sentquantity'), styles: { width: "10%" } },
        { key: 'quantityreceived', header: t('stockmanagement.stockoperation.items.quantityreceived'), styles: { width: "8%", whiteSpace: "nowrap" } },
        { key: 'quantityreceiveduom', header: t('stockmanagement.stockoperation.items.quantityreceiveduom'), styles: { width: "15%" } },
    ];
