    ...
    return <div className="row">
        <div className="col-12">
            <Routes>
                ...
                <Route key="new-stock-op-route" path={"/new/:id"} element={<RequirePriviledge requireAllPrivileges={true} privileges={[priv.TASK_STOCKMANAGEMENT_STOCKOPERATIONS_MUTATE]} userContext={userContext}><StockOperationsEdit key={`new-${currentLocation.key}`} /></RequirePriviledge>} />
                <Route key="edit-stock-op-route" path={"/:id"} element={<RequirePriviledge requireAllPrivileges={false} privileges={[priv.APP_STOCKMANAGEMENT_STOCKOPERATIONS, priv.TASK_STOCKMANAGEMENT_STOCKOPERATIONS_MUTATE]} userContext={userContext}><StockOperationsEdit key={`edit-${currentLocation.key}`} /></RequirePriviledge>} />
