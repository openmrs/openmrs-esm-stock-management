...
export const EditStockItem: React.FC<EditStockItemProps> = ({
  ...
  const [
    getStockSources,
    { data: stockSourceList, isFetching: isFetchingStockSourceList },
  ] = useLazyGetStockSourcesQuery();
  const formikRef = useRef<FormikProps<FormikValues>>(null);
  const [
    getDispensingUnits,
    { data: dispensingUnits, isFetching: isFetchingDispensingUnits },
  ] = useLazyGetConceptByIdQuery();
  const [
    getCategories,
    { data: categories, isFetching: isFetchingCategories },
  ] = useLazyGetConceptByIdQuery();
  ...
  useEffect(() => {
    formikRef?.current?.setFieldValue(
      "hasPackagingUnits",
      packagingUnits != null && packagingUnits.length > 0
    );
  }, [packagingUnits]);
    ...
    setModel(
      produce((draft) => {
        if (data?.selectedItem) {
          ...
          draft.drugName = `${data?.selectedItem?.name}${
            data?.selectedItem?.concept
              ? ` (${data?.selectedItem?.concept.display})`
              : ""
          }`;
        } else {
          draft.drugUuid = null;
  ...
  const onDispensingUnitPackagingUoMChange = (
    ...
    setModel(
      produce((draft) => {
        ...
        draft.dispensingUnitPackagingUoMName =
          selected?.packagingUomName ?? null;
      })
    );
    formikRef?.current?.setFieldValue(
  ...
  const onDefaultStockOperationsUoMChange = (
    evt: ChangeEvent<HTMLSelectElement>
  ) => {
    let selected = packagingUnits.find((x) => x.uuid === evt.target.value);
    setModel(
      produce((draft) => {
        ...
        draft.defaultStockOperationsUoMName =
          selected?.packagingUomName ?? null;
      })
    );
    formikRef?.current?.setFieldValue(
  ...
  const onReorderLevelChange = (evt: React.ChangeEvent<HTMLInputElement>) => {
    try {
      ...
      formikRef?.current?.setFieldValue(
        "hasReorderLevel",
        qtyValue != null || model.reorderLevelUoMUuid != null
      );
    } catch (e) {
      console.log(e);
    }
  ...
  const onReorderLevelUoMChange = (evt: ChangeEvent<HTMLSelectElement>) => {
    ...
    formikRef?.current?.setFieldValue(
      "hasReorderLevel",
      !!selected?.uuid || model.reorderLevel != null
    );
  };
  ...
  const onPurchasePriceChange = (evt: React.ChangeEvent<HTMLInputElement>) => {
    try {
      ...
      formikRef?.current?.setFieldValue(
        "hasPurchasePrice",
        qtyValue != null || !!model.purchasePriceUoMUuid
      );
    } catch (e) {
      console.log(e);
    }
  ...
  const onPurchasePriceUoMChange = (evt: ChangeEvent<HTMLSelectElement>) => {
    ...
    formikRef?.current?.setFieldValue(
      "hasPurchasePrice",
      !!selected?.uuid || model.purchasePrice != null
    );
  };
      ...
      initialValues={{
        isDrug: isNew
          ? model.drugUuid || model.conceptUuid
            ? model.drugUuid && model.drugUuid.length > 0
            : null
          : model.drugUuid != null,
        ...
        hasPurchasePrice:
          (!!model.purchasePrice || !!model.purchasePriceUoMUuid) ?? false,
        hasReorderLevel:
          (!!model.reorderLevel || !!model.reorderLevelUoMUuid) ?? false,
            ...
            <div>
              {canEdit && isNew && (
                <FormGroup
                  ...
                  legendText={t("stockmanagement.stockitem.edit.itemtype")}
                  title={t("stockmanagement.stockitem.edit.itemtype")}
                >
                  <RadioButtonGroup
                    name="isDrug"
                    legendText=""
                  ...
                  >
                    <RadioButton
                      value="true"
                      id="isDrug-true"
                      labelText={t("stockmanagement.drug")}
                    />
                    <RadioButton
                      value="false"
                      id="isDrug-false"
                      labelText={t("stockmanagement.other")}
                    />
                  </RadioButtonGroup>
                </FormGroup>
              )}
              ...
              {canEdit && isNew && model.isDrug && (
                <>
                  <ComboBox
                    titleText={t("stockmanagement.pleasespecify")}
                    invalid={touched.drugUuid && !!errors.drugUuid}
                    invalidText={t2(errors.drugUuid)}
                    name="drugUuid"
                    ...
                    initialSelectedItem={
                      drugList?.results?.find(
                        (p) => p.uuid === model.drugUuid
                      ) ?? ""
                    }
                    itemToString={(item) =>
                      item
                        ? `${item.name}${
                            item.concept ? ` (${item.concept.display})` : ""
                          }`
                        : ""
                    }
              ...
              {canEdit && isNew && model.isDrug != null && !model.isDrug && (
                <>
                  <ComboBox
                    titleText={t("stockmanagement.pleasespecify")}
                    invalid={touched.conceptUuid && !!errors.conceptUuid}
                    invalidText={t2(errors.conceptUuid)}
                    name="conceptUuid"
                    className="select-field"
                    id="conceptUuid"
                    ...
                    initialSelectedItem={
                      conceptsList?.results?.find(
                        (p) => p.uuid === model.conceptUuid
                      ) ?? ""
                    }
                    itemToString={(item) => (item ? `${item.display}` : "")}
                    placeholder={t(
                      "stockmanagement.stockitem.edit.conceptholder"
                    )}
                  />
                </>
              )}
              {isNew && canEdit && showItemExists && (
                <div className="error-msg bold">
                  {t("stockmanagement.stockitem.itemexists")}
                </div>
              )}

              {
                <TextInput
                  ...
                  invalidText={t2(errors.commonName)}
...

              {
                <TextInput
                  ...
                  invalid={touched.acronym && !!errors.acronym}
                  invalidText={t2(errors.acronym)}
              ...
              >
                {canEdit && (
                  <FormGroup
                    ...
                    title={t("stockmanagement.stockitem.edit.hasexpiration")}
                  ...
                  >
                    ...
                    >
                      <RadioButton
                        ...
                        labelText={t("stockmanagement.yes")}
                      />
                      <RadioButton
                        value="false"
                        id="hasExpiration-false"
                        labelText={t("stockmanagement.no")}
                      />
                    </RadioButtonGroup>
                  </FormGroup>
                )}
                ...
                <div
                  style={model.hasExpiration ? {} : { visibility: "hidden" }}
                >
                  <NumberInput
                    id="expiryNotice"
                    name="expiryNotice"
                    ...
                    label={t("stockmanagement.stockitem.edit.expirynotice")}
                    invalid={touched.expiryNotice && !!errors.expiryNotice}
                    invalidText={t2(errors.expiryNotice)}
                  />
                </div>
              </div>

              {canEdit &&
                (isFetchingStockSourceList ||
                  !stockSourceList ||
                  stockSourceList?.results.length === 0) && (
                ...
                !(
                  ...
                  <>
                    <ComboBox
                      ...
                      invalid={
                        touched.preferredVendorUuid &&
                        !!errors.preferredVendorUuid
                      }
                      invalidText={t2(errors.preferredVendorUuid)}
                      name="preferredVendorUuid"
                      className="select-field"
                      id="preferredVendorUuid"
                      items={
                        (stockSourceList?.results?.filter(
                          (x) => x.uuid != null
                        ) ?? []) as any
                      }
              ...
              {!canEdit && (
                <TextInput
                  id="preferredVendorUuidLbl"
                  value={model?.preferredVendorName ?? ""}
                  readOnly={true}
                  labelText={t(
                    "stockmanagement.stockitem.edit.preferredvendor"
                  )}
              ...
              {canEdit && !(isFetchingCategories || !categories) && (
                <>
                  <ComboBox
                    titleText={t("stockmanagement.stockitem.edit.category")}
                    invalid={touched.categoryUuid && !!errors.categoryUuid}
                    invalidText={t2(errors.categoryUuid)}
                    name="categoryUuid"
                    className="select-field"
                    id="categoryUuid"
                    items={
                    ...
                    initialSelectedItem={
                      ...
                      )?.find((p) => p.uuid === model.categoryUuid) ??
                      ({} as any)
                    }
                    itemToString={(item) =>
              ...
              {canEdit &&
                model.isDrug &&
                (isFetchingDispensingUnits || !dispensingUnits) && (
                  <SelectSkeleton hideLabel />
                )}
              {canEdit &&
                model.isDrug &&
                !(isFetchingDispensingUnits || !dispensingUnits) && (
                  <>
                    <ComboBox
                      ...
                      invalid={
                        touched.dispensingUnitUuid &&
                        !!errors.dispensingUnitUuid
                      }
                      invalidText={t2(errors.dispensingUnitUuid)}
                      name="dispensingUnitUuid"
                      className="select-field"
                      id="dispensingUnitUuid"
                      items={
                        ((dispensingUnits?.answers &&
                        dispensingUnits?.answers.length > 0
                          ? dispensingUnits?.answers
                          : dispensingUnits?.setMembers) as any) ?? []
                      }
                      ...
                      initialSelectedItem={
                        ...
                        dispensingUnits?.answers.length > 0
                          ? dispensingUnits?.answers
                          : dispensingUnits?.setMembers
                        )?.find((p) => p.uuid === model.dispensingUnitUuid) ??
                        ({} as any)
                      }
                      itemToString={(item) =>
                        item && item?.display ? `${item?.display}` : ""
              ...
              {!canEdit && model.isDrug && (
                <TextInput
                  id="dispensingUnitUuidLbl"
                  value={model?.dispensingUnitName ?? ""}
                  readOnly={true}
            ...
            <div>
              {!isNew &&
                ...
                packagingUnits.length > 0 && (
                  <Select
                    invalid={
                      touched.dispensingUnitPackagingUoMUuid &&
                      !!errors.dispensingUnitPackagingUoMUuid
                    }
                    invalidText={t2(errors.dispensingUnitPackagingUoMUuid)}
                    name="dispensingUnitPackagingUoMUuid"
                    className="select-field"
                    labelText={t(
                      "stockmanagement.stockitem.edit.dispensingunitpackaginguom"
                    )}
                    id="dispensingUnitPackagingUoMUuid"
                    value={
                      model.dispensingUnitPackagingUoMUuid ?? "placeholder-item"
                    }
                    onChange={onDispensingUnitPackagingUoMChange}
                  >
                    <SelectItem
                      disabled
                      hidden
                      ...
                      text={t(
                        "stockmanagement.stockitem.edit.choosepackaginguom"
                      )}
                    />
              ...
              {!isNew &&
                ...
                (!packagingUnits || packagingUnits.length === 0) && (
                  <ToastNotification
                    ...
                    subtitle={t(
                      "stockmanagement.stockitem.edit.nopackaginguomsubtitle"
                    )}
              ...
              {!isNew && model.isDrug && !canEdit && (
                <TextInput
                  id="dispensingUnitPackagingUoMUuidLbl"
                  value={model?.dispensingUnitPackagingUoMName ?? ""}
                  readOnly={true}
                  labelText={t(
                    "stockmanagement.stockitem.edit.dispensingunitpackaginguom"
                  )}
              ...
              {!isNew &&
                ...
                packagingUnits.length > 0 && (
                  <Select
                    invalid={
                      touched.defaultStockOperationsUoMUuid &&
                      !!errors.defaultStockOperationsUoMUuid
                    }
                    invalidText={t2(errors.defaultStockOperationsUoMUuid)}
                    name="defaultStockOperationsUoMUuid"
                    className="select-field"
                    labelText={t(
                      "stockmanagement.stockitem.edit.defaultstockoperationsuom"
                    )}
                    id="defaultStockOperationsUoMUuid"
                    value={
                      model.defaultStockOperationsUoMUuid ?? "placeholder-item"
                    }
                    onChange={onDefaultStockOperationsUoMChange}
                  >
                    <SelectItem
                      disabled
                      hidden
              ...
              {!isNew && !canEdit && (
                <TextInput
                  id="defaultStockOperationsUoMUuidLbl"
                  value={model?.defaultStockOperationsUoMName ?? ""}
                  readOnly={true}
                  labelText={t(
                    "stockmanagement.stockitem.edit.defaultstockoperationsuom"
                  )}
              ...
              {!isNew && !(!packagingUnits || packagingUnits.length === 0) && (
                <NumberInput
                  ...
                  label={t("stockmanagement.stockitem.edit.reorderlevel")}
                  invalid={touched.reorderLevel && !!errors.reorderLevel}
                  invalidText={t2(errors.reorderLevel)}
                />
              )}
              ...
              {!isNew &&
                ...
                packagingUnits.length > 0 && (
                  <Select
                    invalid={
                      touched.reorderLevelUoMUuid &&
                      !!errors.reorderLevelUoMUuid
                    }
                    invalidText={t2(errors.reorderLevelUoMUuid)}
                    name="reorderLevelUoMUuid"
                    className="select-field"
                    labelText={t(
                      "stockmanagement.stockitem.edit.reorderleveluom"
                    )}
                    id="reorderLevelUoMUuid"
                    value={model.reorderLevelUoMUuid ?? "placeholder-item"}
                    onChange={onReorderLevelUoMChange}
                  >
                    <SelectItem
                      value="placeholder-item"
                      text={t("stockmanagement.notset")}
                    />
                    {packagingUnits?.map((uom) => {
                      return (
                        <SelectItem
              ...
              {!isNew &&
                ...
                (!packagingUnits || packagingUnits.length === 0) && (
                  <ToastNotification
                    kind="warning-alt"
                    hideCloseButton={true}
                    title={t("stockmanagement.stockitem.edit.reorderleveluom")}
                    subtitle={t(
                      "stockmanagement.stockitem.edit.nopackaginguomsubtitle"
                    )}
                    notificationType={"inline"}
              ...
              {!isNew && !canEdit && (
                <TextInput
                  id="reorderLevelUoMUuidLbl"
                  value={model?.reorderLevelUoMName ?? ""}
                  readOnly={true}
                  labelText={t(
                    "stockmanagement.stockitem.edit.reorderleveluom"
                  )}
              ...
              {!isNew && !(!packagingUnits || packagingUnits.length === 0) && (
                <NumberInput
                  ...
                  label={t("stockmanagement.stockitem.edit.purchaseprice")}
                  invalid={touched.purchasePrice && !!errors.purchasePrice}
                  invalidText={t2(errors.purchasePrice)}
                />
              )}
              ...
              {!isNew &&
                ...
                packagingUnits.length > 0 && (
                  <Select
                    invalid={
                      touched.purchasePriceUoMUuid &&
                      !!errors.purchasePriceUoMUuid
                    }
                    invalidText={t2(errors.purchasePriceUoMUuid)}
                    name="purchasePriceUoMUuid"
                    className="select-field"
                    labelText={t(
                      "stockmanagement.stockitem.edit.purchasepriceuom"
                    )}
                    id="purchasePriceUoMUuid"
                    value={model.purchasePriceUoMUuid ?? "placeholder-item"}
                    onChange={onPurchasePriceUoMChange}
                  >
                    <SelectItem
                      value="placeholder-item"
                      text={t("stockmanagement.notset")}
              ...
              {!isNew &&
                ...
                (!packagingUnits || packagingUnits.length === 0) && (
                  <ToastNotification
                    kind="warning-alt"
                    hideCloseButton={true}
                    title={t("stockmanagement.stockitem.edit.purchasepriceuom")}
                    subtitle={t(
                      "stockmanagement.stockitem.edit.nopackaginguomsubtitle"
                    )}
                    notificationType={"inline"}
              ...
              {!isNew && !canEdit && (
                <TextInput
                  id="purchasePriceUoMUuidLbl"
                  value={model?.purchasePriceUoMName ?? ""}
                  readOnly={true}
                  labelText={t(
                    "stockmanagement.stockitem.edit.purchasepriceuom"
                  )}
