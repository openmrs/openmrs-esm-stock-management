...
export const ImportModalPopup: React.FC<ImportModalPopupProps> = ({
  ...
  const [
    importStockItems,
    { data: importResult, isLoading: importingStockItems },
    ...
    <>
      ...
      {!importingStockItems && (
        <Modal
          size="sm"
          open={openModal}
          className="stkpg-import"
          primaryButtonText={t("stockmanagement.import")}
        ...
        >
          {displayErrors && (
            <div>
              <div className="stkpkg-upload-state">
                Stock items created: <b>{importResult?.createdCount}</b>{" "}
              ...
              <div className="error-text">
                ...
                {importResult?.hasErrorFile && importResult.uploadSessionId && (
                  <div>
                    ...
                    <a
                      rel="noreferrer"
                      href={URL_IMPORT_ERROR_FILE(importResult.uploadSessionId)}
                      target={"_blank"}
                    >
                      here
                    </a>{" "}
          ...
          <FormGroup
            ...
            legendText={t("stockmanagement.stockitem.edit.hasheader")}
            title={t("stockmanagement.stockitem.edit.hasheader")}
          >
            <RadioButtonGroup
              name="hasHeader"
