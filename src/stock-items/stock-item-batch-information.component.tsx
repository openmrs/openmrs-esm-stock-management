...
const StockItemBatchInformationTable: React.FC<
  StockItemBatchInformationTableProps
> = ({ partyList, stockItemUuid }) => {
  ...
  const {
    data: stockItemBatchInformation,
    isLoading: isLoadingBatchInformation,
  ...
  const headers = [
    ...
    {
      key: "batchno",
      header: t("stockmanagement.stockitem.batchinfo.batchno"),
    },
    {
      key: "quantity",
    ...
    {
      key: "expiration",
      header: t("stockmanagement.stockitem.batchinfo.expiration"),
    },
  ];
