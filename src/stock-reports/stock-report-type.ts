...
export const getReportLimitLabel = (reportSystemName: string | undefined | null) => {
    return isForecastReport(reportSystemName) ? 'stockmanagement.report.edit.months' : 'stockmanagement.report.edit.limit';
}

export const getReportStartDateLabel = (reportSystemName: string | undefined | null) => {
    return isForecastReport(reportSystemName) ? 'stockmanagement.report.edit.historicalstartdate' : 'stockmanagement.report.edit.startdate';
}

export const getReportEndDateLabel = (reportSystemName: string | undefined | null) => {
    return isForecastReport(reportSystemName) ? 'stockmanagement.report.edit.historicalenddate' : 'stockmanagement.report.edit.enddate';
}
