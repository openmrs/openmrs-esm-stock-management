import { Checkbox, ComboBox, DatePicker, DatePickerInput, Form, Modal, SelectSkeleton } from 'carbon-components-react';
...
import { DATE_PICKER_CONTROL_FORMAT, DATE_PICKER_FORMAT, formatDisplayDate, formatForDatePicker } from '../core/utils/datetimeUtils';
...
export const ViewReport: React.FC<ViewReportProps> = ({
    ...
    const onReportTypeChanged = (data: { selectedItem: any }) => {
        ...
        setModel({ reportName: data.selectedItem?.display ?? data?.selectedItem?.name, reportSystemName: newValue, childLocations: false });
    ...
    }, [displayStockItemCategory, displayLocation, displayStockSource, displayStockSourceDestination, displayDate, displayStartDate, displayEndDate, createBatchJob, setShowSplash, t, displayChildLocations, refreshBatchJobs, onCloseEditDialog]);
