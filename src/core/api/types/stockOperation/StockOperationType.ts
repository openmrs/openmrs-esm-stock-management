...
export const StockOperationTypeRequiresStockAdjustmentReason = (operationType: string) => {
    return operationType === "adjustment" || operationType === "stocktake" || operationType === "disposed";
}


export const StockOperationTypeIsNegativeQtyAllowed = (operationType: string) => {
...
export const StockOperationTypeRequiresActualBatchInformation = (operationType: string) => {
    return operationType === RECEIPT_OPERATION_TYPE || operationType === "initial";
}
...
export const StockOperationTypeCanCapturePurchasePrice = (operationType: string) => {
    return operationType === RECEIPT_OPERATION_TYPE || operationType === "initial";
}

export const StockOperationTypeCanBeRelatedToRequisition = (operationType: string) => {
    return operationType === STOCK_ISSUE_OPERATION_TYPE;
}

export const StockOperationTypeRequiresDispatchAcknowledgement = (operationType: string) => {
    return operationType === STOCK_ISSUE_OPERATION_TYPE || operationType === "return";
}

export const StockOperationTypeHasPrint = (operationType: string) => {
    return operationType === STOCK_ISSUE_OPERATION_TYPE || StockOperationTypeIsRequistion(operationType) || StockOperationTypeIsReceipt(operationType) || StockOperationTypeIsTransferOut(operationType);
}
