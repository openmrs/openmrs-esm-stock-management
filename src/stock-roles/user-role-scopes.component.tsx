  ...
  return (
    <div className="row">
      <div className="col-12">
        <Routes>
          <Route
            key="new-user-role-scopes-route"
            path={"/new"}
            element={
              <RequirePriviledge
                requireAllPrivileges={true}
                privileges={[TASK_STOCKMANAGEMENT_USERROLESCOPES_MUTATE]}
          ...
          />
          <Route
            key="edit-user-role-scopes-route"
            path={"/:id"}
            element={
              <RequirePriviledge
                requireAllPrivileges={true}
          ...
          />
          <Route
            key="list-user-role-scopes-route"
            path={"/"}
            element={
              <RequirePriviledge
                requireAllPrivileges={true}
                privileges={[APP_STOCKMANAGEMENT_USERROLESCOPES]}
                userContext={userContext}
              >
                <UserRoleScopeList />
              </RequirePriviledge>
          ...
          />
          <Route
            key="default-user-role-scopes-route"
            path={"*"}
            element={<Navigate to={URL_USER_ROLE_SCOPES} />}
          />
          ,
        </Routes>
      </div>
