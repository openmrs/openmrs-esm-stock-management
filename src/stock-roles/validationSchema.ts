...
const validationSchema = {
  ...
  operationType: Yup.array()
    ...
    .required("stockmanagement.userrolescope.validation.operationtyperequired"),
  location: Yup.array()
    .min(1, "stockmanagement.userrolescope.validation.locationrequired")
    .of(Yup.string().required())
    .required("stockmanagement.userrolescope.validation.locationrequired"),
};
  ...
  Object.assign(
    {},
    {
      user: Yup.string().required(
        "stockmanagement.userrolescope.validation.userrequired"
      ),
    },
    validationSchema
  )
