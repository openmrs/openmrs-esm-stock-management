...
const StockOperations = lazy(() => import("../stock-operations/stock-operations.component"));
const UserRoleScopes = lazy(() => import("../stock-roles/user-role-scopes.component"));
const StockItems = lazy(() => import("../stock-items/stock-items.component"));
const StockSources = lazy(() => import("../stock-sources/stock-sources.component"));
const Locations = lazy(() => import("../stock-locations/stock-locations.component"));
const Reports = lazy(() => import("../stock-reports/stock-reports.component"));


export const protectedRoutes = (userContext: UserContextState) => [
    <Route key="home" path={URL_STOCK_HOME} element={<RequirePriviledge requireAllPrivileges={false} privileges={[]} userContext={userContext}><StockDashboard /></RequirePriviledge>} />,
