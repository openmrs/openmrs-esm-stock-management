...
export const StockSources: React.FC<StockSourcesProps> = ({ userContext }) => {
  return (
    <div className="row">
      <div className="col-12">
        <Routes>
          <Route
            ...
            element={
              <RequirePriviledge
                ...
                privileges={[APP_STOCKMANAGEMENT_STOCKSOURCES]}
          ...
          <Route
            ...
            path={"*"}
            element={<Navigate to={URL_STOCK_SOURCES_ROUTES} />}
          />
          ,
        </Routes>
      </div>
